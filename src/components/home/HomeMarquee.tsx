      ...
      <div className="container py-8 md:py-10 lg:py-12">
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            <p className="font-display uppercase tracking-[0.3em] text-[11px] text-accent flex items-center gap-2">
              <Sparkles className="h-3.5 w-3.5" />
              Now Playing on Main Street
            </p>
            <h1 className="mt-3 font-display uppercase text-4xl md:text-5xl lg:text-6xl leading-[0.95] text-foreground">
              A Century of Stories,
              <span className="block text-primary">Told One Screening at a Time.</span>
            </h1>
            <p className="mt-4 font-serif italic text-muted-foreground text-base md:text-lg max-w-xl">
              Independent film, live performance, and community gatherings inside
              Moscow's historic 1926 movie house.
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 md:justify-end md:text-right">
            <p className="font-serif text-sm text-muted-foreground flex items-center gap-2">
